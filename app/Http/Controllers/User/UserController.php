...
class UserController extends Controller
{
        ...
        $student = Models\DetailStudent::select('u.tgl_langganan_akhir','u.email_verified_at','u.status_aktif','u.email','u.nama', 'detail_students.jenis_kel','detail_students.tgl_lahir','detail_students.tempat_lahir','detail_students.alamat','u.uuid AS user_uuid')
            ...
            return DataTables::of($student)
                ...
                ->addColumn('action', function ($student) {
                    $actionBtn = '<a href="http://admin.kkuljaemkoreanapp.com/akun_pengguna/siswa/detail?id='.$student->user_uuid.'" class="btn btn-primary btn-sm">Rincian</a>
                                <a href="http://admin.kkuljaemkoreanapp.com/akun_pengguna/siswa/edit?token='.$student->user_uuid.'" class="btn btn-info btn-sm">Edit</a> 
                                <a href="#" onclick="hapus(https://kkuljaem-api-new-3-ft4mz.ondigitalocean.app/api/admin/user/student?token='.$student->user_uuid.'" class="btn btn-danger btn-sm">Delete</a>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
                ->make(true);
    ...
    public function studentList(Request $request){
        ...
        $limit = $request->has('limit') ? $request->get('limit') : 3000;
