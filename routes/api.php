...
Route::group(['prefix' => 'api/force'], function () {
    ...
    Route::get('question/url',      [Helper\ForceController::class,'forceMentorDetailUrl']);
    Route::get('option/url',      [Helper\ForceController::class,'forceQuestionUrl']);
    Route::get('mentor-detail/url',      [Helper\ForceController::class,'forceOptionUrl']);
});    
