...
Route::group(['prefix' => 'api/admin/user'], function () {
    ...
    Route::get('/student/lists', function (Request $request) {
        // if ($request->ajax()) {
            $student = DB::table('detail_students as d')->select('u.tgl_langganan_akhir','u.email_verified_at','u.status_aktif','u.email','u.nama', 'd.jenis_kel','d.tgl_lahir','d.tempat_lahir','d.alamat','u.uuid AS user_uuid')
                    ->rightJoin('users as u', 'd.id_users', '=', 'u.id')
            ...
            return DataTables::of($student)
                ...
                ->addColumn('action', function ($student) {
                    $actionBtn = '<a href="http://admin.kkuljaemkoreanapp.com/akun_pengguna/siswa/detail?id='.$student->user_uuid.'" class="info btn btn-info btn-sm">Rincian</a>
                                <a href="http://admin.kkuljaemkoreanapp.com/akun_pengguna/siswa/edit?token='.$student->user_uuid.'" class="edit btn btn-success btn-sm">Edit</a> 
